if(NOT DEFINED MAP_STUDIO OR NOT DEFINED PROJECT_VALIDATE OR
   NOT DEFINED SOURCE_FIXTURE OR NOT DEFINED TEST_ROOT)
    message(FATAL_ERROR "Map Studio Transformation E2E arguments are required")
endif()
...
execute_process(
    COMMAND "${MAP_STUDIO}" --e2e-transformation
...
if(STUDIO_RESULT EQUAL 77)
    message("SKIP: Map Studio transformation E2E requires a display")
    return()
elseif(NOT STUDIO_RESULT EQUAL 0)
    message(FATAL_ERROR
        "Map Studio Transformation E2E failed (${STUDIO_RESULT})\n${STUDIO_OUTPUT}\n${STUDIO_ERROR}")
endif()
...
if(NOT VALIDATE_RESULT EQUAL 0)
    message(FATAL_ERROR
        "Transformation preview project is invalid\n${VALIDATE_OUTPUT}\n${VALIDATE_ERROR}")
endif()
