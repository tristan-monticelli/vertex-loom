...
string(JSON ANCHOR_PIXELS GET "${VISUAL_PROBE_CONTENT}" anchor_pixels)
string(JSON SELECTED_ANCHOR_PIXELS GET "${VISUAL_PROBE_CONTENT}" selected_anchor_pixels)
string(JSON HANDLE_PIXELS GET "${VISUAL_PROBE_CONTENT}" handle_pixels)
if(ANCHOR_PIXELS LESS 30 OR SELECTED_ANCHOR_PIXELS LESS 10 OR HANDLE_PIXELS LESS 20)
    message(FATAL_ERROR
        "Vector Canvas E2E gizmos are not visibly rendered: ${VISUAL_PROBE_CONTENT}")
endif()
