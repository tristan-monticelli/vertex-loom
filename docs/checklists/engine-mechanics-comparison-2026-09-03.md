...
| UX globale | A55 — sélection logique synchronisée entre arbre, canvas, timeline, graphe et inspecteur | Behavior est stable par ID ; `EditorContext` conserve désormais pour Entity le primaire et la sélection multiple par IDs, résolus chaque frame par arbre/canvas/inspecteur ; Map, Scene et autres graphes gardent encore des états locaux | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | Entity ne dérive plus après réorganisation ou retour historique ; le propriétaire unique transversal reste incomplet | P0 | Étendre le même contrat aux sélections Map, Scene et aux autres graphes | G9, U15, E9, GM8, C6, S5, R6 |
