...
| Construire une mécanique | Canevas Map Studio avec cartes, ports, flèches et connexion compatible ; E2E clics→reload→pas fixe | L3 | partiel | Le graphe est utilisable ; les corps, pivots et joints ne se manipulent pas encore directement sur la map | P0 | Ajouter handles body/pivot/joint sur le canvas de map et synchroniser leur sélection |
...
| Mécaniques | A27 — nœuds body/pivot/joint/motor | `MechanicNodeKind`, compilateur/presets ; canevas cartes/ports/flèches ; E2E reconnecte par clics, recharge et avance la simulation | partiel | oui | oui | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | N/A | N/A | Graphe nominal prouvé ; handles physiques directs et exécution du paquet publié restent absents | P0 | Ajouter handles body/pivot/joint puis preuve package→runtime | G5, U4, E4, GM2, C4 |
