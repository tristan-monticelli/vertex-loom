...
| Architecture UX | A61 — shell et workspaces modulaires testables | Map, Mechanics, Behavior, Animation, publication Animation et toutes les surfaces Entity possèdent leurs modules ; Visual Component, le panneau de layers Visual Composition et le panneau Pen Textured Path possèdent désormais leur état, tandis que style shader, animation de texture et raster restent dans `asset_studio/main.cpp` | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | Le parcours Entity et trois sous-surfaces Visual sont isolés du shell ; style/preview Textured Path, inspection raster et plusieurs harnais restent couplés | P0 | Extraire ensuite le style/preview Textured Path et raster, puis remplacer les probes globaux par des adaptateurs possédés par les modules | G18, U17, E19, GM5, C11, S5, R6 |
