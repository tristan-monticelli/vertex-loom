...
| Outils canvas | A59 — modes contextuels et manipulation directe des relations | Gizmos Entity/vectoriels, placement Map et déplacement Mechanics des corps/pivots/capteurs ; rig, IK, XPBD et joints mécaniques restent des formulaires | partiel | oui | oui | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | La manipulation Mechanics de base est prouvée, mais le runtime physique reste plus riche que l'authoring visuel | P0 | Poignées taille/rotation/joint, puis modes canvas Rig et Physics | G6, U8, E18, GM9, C6, S6, R6 |
