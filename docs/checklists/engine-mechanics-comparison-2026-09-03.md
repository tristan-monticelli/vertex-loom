...
| Déplacement | A12 — rail de déplacement d'instance | `MapInstance.pathFollower` est chargé, échantillonné et évalué à chaque pas fixe du Preview Runtime ; édition Studio dédiée et preuve paquet publié encore absentes | non | oui | oui | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | N/A | partiel | Le déplacement runtime fonctionne, mais le parcours de création n'est pas encore exposé dans Map Studio | P1 | Ajouter un panneau PathFollower contextuel avec aperçu, vitesse, boucle, orientation et validation avant publication | G2, U2, E2, S2 |
