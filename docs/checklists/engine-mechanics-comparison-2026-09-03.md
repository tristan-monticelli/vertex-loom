...
| Déplacement | A12 — rail de déplacement d'instance | `MapInstance.pathFollower` est éditable dans l'Inspector Map, chargé et évalué à chaque pas fixe du Preview Runtime ; preuve paquet publié encore absente | oui | oui | oui | implémenté | ✓ | ✓ | ✓ | ✓ | ✓ | N/A | partiel | Le parcours création → Preview est disponible ; il manque une preuve E2E du paquet publié | P1 | Ajouter un scénario E2E qui configure le rail dans Map Studio puis recharge le paquet exact | G2, U2, E2, S2 |
