...
L'audit initial révélait deux parcours distincts mais mal raccordés. Le
workspace Entity corrige désormais la première rupture ; le travail Animation
reste mesuré séparément ci-dessous jusqu'à fermeture de son auto-key et de ses
outils de sélection temporelle.
