...
| Architecture UX | A61 — shell et workspaces modulaires testables | Map, Mechanics, Behavior, Animation, publication Animation, Rig/Physics, hiérarchie Entity et propriétés communes du nœud possèdent leurs modules ; artwork/overrides Entity et Visual restent dans `asset_studio/main.cpp` | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | Structure et propriétés communes Entity deviennent testables sans la boucle SDL, mais artwork/overrides et plusieurs harnais restent couplés au shell Asset | P0 | Extraire artwork/overrides Entity puis Visual hors du bootstrap | G18, U17, E19, GM5, C11, S5, R6 |
