...
| Architecture UX | A61 — shell et workspaces modulaires testables | Map, Mechanics, Behavior, Animation, publication Animation, Rig/Physics, hiérarchie Entity, propriétés communes et artwork/overrides Entity possèdent leurs modules ; Visual reste dans `asset_studio/main.cpp` | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | Le parcours Entity est isolé du shell et son type d'artwork reste accessible en mode guidé ; Visual et plusieurs harnais restent couplés | P0 | Extraire Visual puis remplacer les probes globaux par des adaptateurs possédés par les modules | G18, U17, E19, GM5, C11, S5, R6 |
