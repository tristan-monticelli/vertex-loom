...
| Construire une mécanique | Graphe et canevas spatial côte à côte ; sélection commune ; déplacement, taille et rotation directs ; E2E connexion+3 glissers→reload→pas fixe→package→runtime | L4 | partiel | Le parcours principal est utilisable ; poignée de joint et overlay sur la map manquent | P1 | Ajouter la poignée de joint puis manipuler la mécanique dans le contexte de la map |
...
ImGui ; `map_studio/main.cpp` contient 3 024 lignes et 423 appels ImGui. Le
...
| Mécaniques | A27 — nœuds body/pivot/joint/motor | `MechanicNodeKind`, compilateur/presets ; graphe et canevas spatial synchronisés ; corps/pivots déplaçables, corps redimensionné/tourné ; E2E reconnecte, recharge, simule, publie et lance le paquet | partiel | oui | oui | oui | ✓ | ✓ | ✓ | ✓ | ✓ | N/A | N/A | Déplacement, taille, rotation et exécution publiée sont prouvés ; poignée de joint et édition dans le contexte map restent absentes | P1 | Ajouter la poignée de joint puis unifier sélection Mechanics/Map | G5, U4, E4, GM2, C4 |
...
| Outils canvas | A59 — modes contextuels et manipulation directe des relations | Gizmos Entity/vectoriels, IK chaîne+cible, placement Map et déplacement/taille/rotation Mechanics ; le mesh possède une initialisation nominale valide, mais mesh, poids, XPBD et joints restent sans manipulation directe | partiel | oui | oui | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | IK, initialisation mesh et transformations Mechanics sont prouvés, mais plusieurs systèmes avancés restent derrière des formulaires | P0 | Poignée de joint, puis édition mesh/poids et Physics canvas | G6, U8, E18, GM9, C6, S6, R6 |
...
| Architecture UX | A61 — shell et workspaces modulaires testables | `map_studio/main.cpp` est à 3 024 lignes ; Behavior, Animation, preuve de publication Animation et Rig/Physics Entity possèdent leurs modules, mais `asset_studio/main.cpp` reste à 10 795 lignes | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | Animation est modulaire et publiée, mais hiérarchie/inspecteur Entity, Visual et plusieurs harnais restent couplés au shell Asset | P0 | Continuer tranche 3 : hiérarchie/inspecteur Entity puis Visual hors du bootstrap | G18, U17, E19, GM5, C11, S5, R6 |
