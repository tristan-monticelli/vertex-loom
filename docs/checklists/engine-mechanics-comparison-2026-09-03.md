...
| UX globale | A56 — registre d'actions et palette de commandes contextuelle | Save, Undo/Redo et l'intention Entity `animate_selection` partagent registre, disponibilité, bouton et palette ; les autres commandes métier restent directes | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | partiel | partiel | Le parcours Entity→Animation devient découvrable et cohérent, mais création avancée, graphes et publication n'ont pas encore tous un propriétaire d'action unique | P0 | Migrer ensuite les actions métier par parcours et exiger une preuve bouton + palette + raison de blocage | G16, U15, E17, GM8, C10, S5, R6 |
