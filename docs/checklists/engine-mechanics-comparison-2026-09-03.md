...
| Déplacement | A12 — rail de déplacement d'instance | `MapInstance.pathFollower` optionnel est sérialisable et validé ; aucune évaluation Map/Runtime n'est encore branchée | non | non | non | contrat seulement | ✓ | ✓ | ✓ | ✓ | ✓ | N/A | partiel | Le contrat préparatoire existe, mais aucune plateforme ou caméra ne suit encore le rail | P1 | Brancher le sampler à Map Studio, Preview Runtime et l'orientation d'instance | G2, U2, E2, C2, S2 |
