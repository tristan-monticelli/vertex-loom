...
| Architecture UX | A61 — shell et workspaces modulaires testables | Map, Mechanics, Behavior, Animation, publication Animation et toutes les surfaces Entity possèdent leurs modules ; Visual Component possède désormais son inspecteur et son état, tandis que compositions, chemins et raster restent dans `asset_studio/main.cpp` | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | Entity et la première sous-surface Visual sont isolés du shell ; les autres surfaces Visual et plusieurs harnais restent couplés | P0 | Extraire ensuite Composition, Textured Path et raster, puis remplacer les probes globaux par des adaptateurs possédés par les modules | G18, U17, E19, GM5, C11, S5, R6 |
