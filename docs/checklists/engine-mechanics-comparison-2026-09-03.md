...
| Architecture UX | A61 — shell et workspaces modulaires testables | Map, Mechanics, Behavior, Animation, publication Animation et toutes les surfaces Entity possèdent leurs modules ; Visual Component, le panneau de layers Visual Composition, le panneau Pen Textured Path et l’inspecteur Raster View possèdent désormais leur état, tandis que style shader, animation de texture et canvas raster restent dans `asset_studio/main.cpp` | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | Le parcours Entity et quatre sous-surfaces Visual sont isolés du shell ; style/preview Textured Path, canvas raster et plusieurs harnais restent couplés | P0 | Extraire ensuite le style/preview Textured Path et le canvas raster, puis remplacer les probes globaux par des adaptateurs possédés par les modules | G18, U17, E19, GM5, C11, S5, R6 |
