...
| Architecture UX | A61 — shell et workspaces modulaires testables | Map, Mechanics, Behavior, Animation, publication Animation, Rig/Physics et désormais hiérarchie Entity possèdent leurs modules ; l'Inspector Entity détaillé et Visual restent dans `asset_studio/main.cpp` | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | La hiérarchie Entity devient testable sans la boucle SDL, mais l'Inspector et plusieurs harnais restent couplés au shell Asset | P0 | Extraire ensuite l'Inspector Entity détaillé puis Visual hors du bootstrap | G18, U17, E19, GM5, C11, S5, R6 |
