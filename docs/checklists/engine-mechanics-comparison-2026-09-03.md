...
| Construire un Behavior Graph | Palette de types recherchable, ajout sans ID, canevas de cartes/ports/flèches, connexion source→cible et inspecteur typé | L3 | utilisable | Ajout, connexion et exécution sont prouvés ; trace sur le graphe et breakpoint manquent | P1 | Ajouter mise en évidence de la trace et breakpoints |
...
| Comportement | A23 — BehaviorGraph générique signaux/actions | `behavior_graph.hpp` ; palette recherchable avec ID généré, canevas relié par clics, reload puis exécution | oui | oui | oui | implémenté | ✓ | ✓ | ✓ | partiel | ✓ | N/A | ✓ | Création et connexion nominales utilisables ; le debug visuel manque | P1 | Ajouter trace sur cartes et breakpoints | E10, C8, R5 |
...
| Publication | A36 — paquet map/campagne portable, dépendances, version runtime | `map_package.cpp` ; E2E Scene publie puis recharge scène/map/collision/trigger depuis le paquet | partiel | oui | oui | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | export runtime | export `.riv` | Chargement du paquet prouvé, mais flux auteur transversal et gate licences/signature restent ouverts | P0 | Étendre le même E2E aux gestes UI Entity/Animation/Mechanic et au binaire release | G7, U7, E7, C5, S3, R3 |
