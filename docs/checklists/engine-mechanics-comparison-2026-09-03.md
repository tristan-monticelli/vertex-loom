...
| Construire une mécanique | Graphe et canevas spatial côte à côte ; sélection commune ; déplacement, taille, rotation et joint directs ; E2E connexion+4 glissers→reload→pas fixe→package→runtime | L4 | utilisable | Le parcours principal est prouvé ; l'édition dans le contexte visuel de la map manque | P1 | Manipuler la mécanique depuis l'instance sélectionnée dans la map |
...
ImGui ; `map_studio/main.cpp` contient 3 066 lignes et 423 appels ImGui. Le
...
| Mécaniques | A27 — nœuds body/pivot/joint/motor | `MechanicNodeKind`, compilateur/presets ; graphe et canevas spatial synchronisés ; déplacement, taille, rotation et couronne de joint ; E2E reconnecte, recharge, simule, publie et lance le paquet | oui | oui | oui | implémenté | ✓ | ✓ | ✓ | ✓ | ✓ | N/A | N/A | Le parcours Mechanics est prouvé ; l'édition dans le contexte de l'instance map reste séparée | P1 | Unifier sélection et manipulation Mechanics/Map | G5, U4, E4, GM2, C4 |
