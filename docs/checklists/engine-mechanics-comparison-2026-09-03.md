...
Behavior et Animation Graph : `asset_studio/main.cpp` contient 12 386 lignes et 1 614 appels
...
| Architecture UX | A61 — shell et workspaces modulaires testables | `map_studio/main.cpp` est descendu à 2 937 lignes après extraction de cinq modules ; Behavior et Animation Graph possèdent désormais leurs modules et états, mais `asset_studio/main.cpp` reste à 12 386 lignes | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | La frontière de workspace est prouvée, mais Visual, Entity, timeline/inspecteur Animation et les harnais E2E restent fortement couplés au shell Asset | P0 | Continuer tranche 3 : timeline Animation puis Entity/Visual hors du bootstrap, mêmes sessions et E2E | G18, U17, E19, GM5, C11, S5, R6 |
...
Behavior et Animation Graph ont commencé à déléguer leurs workspaces, mais que
Visual, Entity, la timeline/inspecteur Animation et une grande partie de leurs E2E restent assemblés dans le point
