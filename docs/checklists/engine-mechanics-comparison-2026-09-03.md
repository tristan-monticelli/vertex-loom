...
| Surfaces | A07 — source intacte par défaut, recoloration explicite | `BeamColorMode`, tests presets, E2E Beam/Button et smoke GL réels ; ADR-0136/0138 ; aucune comparaison pixel-à-pixel dédiée n’est encore enregistrée | oui | oui | oui | partiel | ✓ | ✓ | ✓ | ✓ | ✓ | N/A | ✓ | Défaut bleu/reflet corrigé et anciens JSON inchangés, mais l’invariance exacte des pixels à intensité zéro reste à prouver | P0 | Ajouter une fixture asymétrique et une matrice pixel Studio/Preview/runtime pour intensité zéro, chaque couleur et chaque intensité, sans `SKIP` | G1, U1, E1, R2 |
...
| Architecture UX | A61 — shell et workspaces modulaires testables | Map, Mechanics, Behavior, Animation, publication Animation et toutes les surfaces Entity possèdent leurs modules ; Visual Component, le panneau de layers Visual Composition, le panneau Pen Textured Path, l’inspecteur Raster View et le canvas Raster Crop possèdent désormais leur état/gestes, tandis que style shader et animation de texture restent dans `asset_studio/main.cpp` | partiel | N/A | N/A | partiel | ✓ | ✓ | ✓ | non prouvé | partiel | non prouvé | non prouvé | Le parcours Entity et cinq sous-surfaces Visual sont isolés du shell ; style/preview Textured Path et plusieurs harnais restent couplés | P0 | Extraire ensuite le style/preview Textured Path et remplacer les probes globaux par des adaptateurs possédés par les modules | G18, U17, E19, GM5, C11, S5, R6 |
