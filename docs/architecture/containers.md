...
C4Container
    ...
    System_Boundary(fabric, "Vertex Loom") {
        ...
        Container(map, "Map Studio", "C++20 / SDL2 / Dear ImGui", "Édite maps, événements et payloads, triggers et collisions via MapSession, avec inspecteurs de points et triggers, annotations d’événements, canvas 2D, grille, caméra pan/zoom, cadrage automatique, sélection et poignées de transformation réversibles")
