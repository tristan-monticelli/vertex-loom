...
C4Container
    ...
    System_Boundary(fabric, "Vertex Loom") {
        ...
        Container(map, "Map Studio", "C++20 / SDL2 / OpenGL / Dear ImGui", "Ouvre une map ou scène, choisit les références par pickers typés, compose instances/prefabs/collisions/triggers, édite les paramètres par overrides, administre les transitions de fermeture propre ou avec sauvegarde, partage les champs de nom et recentre le focus sur le premier champ invalide, puis publie après preview")
