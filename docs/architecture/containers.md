...
C4Container
    ...
    System_Boundary(fabric, "Vertex Loom") {
        ...
        Container(map, "Map Studio", "C++20 / SDL2 / Dear ImGui", "Édite maps, événements et triggers via MapSession, avec canvas 2D, grille, caméra pan/zoom, sélection et poignées de transformation réversibles")
