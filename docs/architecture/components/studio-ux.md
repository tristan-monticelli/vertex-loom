...
| Surface Color Mode | mode `Source intacte`/`Recoloration`, reset neutre et synchronisation legacy des surfaces Beam/Button/Artwork | pile d’effets avancée, accès fichier ou couleur produit implicite |
