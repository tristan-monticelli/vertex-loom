...
- Les prompts de projet et d’artwork calculent leur validation avant le rendu
  des champs : le premier champ invalide reçoit le focus clavier et le scroll
  s’y repositionne une seule fois par erreur.
